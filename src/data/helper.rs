...
pub fn wrap(text: &str, width: usize, left: &str, right: &str) -> String {
...
pub fn thin_line(width: usize) -> String {
...
pub fn listify<'a, I>(items: I, bullet: char, width: usize, left: &str, right: &str) -> String
where
    I: Iterator<Item = String>,
{
    items
